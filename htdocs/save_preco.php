...
$stmt->bind_param("sddddddddddddddddd", base64_encode($nome), $pv, $cmv, $frete, $cartaoP, $cartaoR, $impostoP, $impostoR, $comissaoP, $comissaoR, $total, $mlar, $mlap, $mldp, $vvn, $cpap, $cpa, $roas);
