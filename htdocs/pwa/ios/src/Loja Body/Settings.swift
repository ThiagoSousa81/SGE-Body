...
let rootUrl = URL(string: "https://bodycruz.com.br/?utm_source=pwa_by_ampifyme&utm_medium=pwa_app&utm_campaign=pwa_app")!

// allowed origin is for what we are sticking to pwa domain
// This should also appear in Info.plist
let allowedOrigins: [String] = ["bodycruz.com.br"]
